...
public class SynthesisStationMenu extends AbstractContainerMenu {
    ...
    private final SynthesisStationBlockEntity blockEntity;
    ...
    public SynthesisStationMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.SYNTHESIS_STATION_MENU.get(), pContainerId);
        checkContainerSize(inv, 6); // throws an exception if the size doesn't add up
        blockEntity = ((SynthesisStationBlockEntity)entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.SYNTHESIS_STATION.get());
    }

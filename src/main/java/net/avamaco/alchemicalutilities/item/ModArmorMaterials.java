...
public enum ModArmorMaterials implements ArmorMaterial {
    IRIDESCENT("iridescent", 15, new int[]{2, 5, 6, 2}, 25, SoundEvents.ARMOR_EQUIP_GOLD, 0.0F, 0.0F, () -> {
        return Ingredient.of(ModItems.IRIDESCENT_GOLD_INGOT.get());
    });
    ...
    public String getName() {
        return AlchemicalUtilities.MOD_ID + ":" + this.name;
    }
